define(function() {
  ...
  getPossiblePropsFor = function(prop) {
    return ['webkit' + prop[0].toUpperCase() + prop.substr(1, prop.length), 'moz' + prop[0].toUpperCase() + prop.substr(1, prop.length), 'ms' + prop[0].toUpperCase() + prop.substr(1, prop.length), prop];
  };
  return css = {
